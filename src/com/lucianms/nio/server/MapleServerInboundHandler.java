...
public class MapleServerInboundHandler extends ChannelInboundHandlerAdapter {
    ...
    public MapleServerInboundHandler(ReceivePacketState packetState, int port, EventLoopGroup parentGroup, EventLoopGroup childGroup) throws Exception {
        this.packetState = packetState;
        discardServer = new NettyDiscardServer(port, this, parentGroup, childGroup);
        discardServer.run();
