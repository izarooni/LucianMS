...
public final class CloseRangeDamageEvent extends AbstractDealDamageEvent {

    private static final Logger LOGGER = LoggerFactory.getLogger(CloseRangeDamageEvent.class);
