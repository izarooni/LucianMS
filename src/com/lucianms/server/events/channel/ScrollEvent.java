 ...
 * @author Frz
 */
public final class ScrollEvent extends PacketEvent {

    private static final Logger LOGGER = LoggerFactory.getLogger(ScrollEvent.class);
    ...
    public void process(SeekableLittleEndianAccessor slea) {
        ...
        slea.skip(4);
        slot = slea.readShort();
        destination = slea.readShort();
        whiteScroll = (byte) (slea.readShort() & 2) == 2;
