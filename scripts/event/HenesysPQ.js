...
function init() {
    exitMap = em.getChannel().getMapFactory().getMap(910010400); // <exit>
    exitClearMap = em.getChannel().getMapFactory().getMap(910010100); // <clear>
    mainMap = em.getChannel().getMapFactory().getMap(910010000); // <main>
