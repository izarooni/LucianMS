    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.sendSimple("Alright, here we go! \r\n#L0##dGamble Mesos ("+ price +" mesos)#k#l\r\n#L1##dNevermind...#k#l")
                ...
                if (playernumber >= 0 && playernumber <= 200) {
                                    ...
                                    cm.dispose();
                } else if(playernumber > 200 && playernumber <= 400) {
                                    ...
                                    cm.dispose();
                } else if(playernumber > 400 && playernumber <= 600) {
                                    ...
                                    cm.dispose();
                } else if(playernumber > 600 && playernumber <= 700) {
                                    ...
                                    cm.dispose();
                } else if(playernumber > 700 && playernumber <= 710) {
