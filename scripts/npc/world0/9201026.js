...
function action(mode, type, selection) {
    ...
    let quest = player.getCustomQuest(POL_LUDI);
    if (quest == null) {
        ...
        if (quest.checkRequirements()) {
            ...
            let content = "Hello, I am Nana the Love Fairy of Ludibrium. You have travelled a great distance for my Proof of Love and I appreciate it!\r\nPlease collect these items for me to obtain your Proof of Love. Good luck~\r\n\r\n";
