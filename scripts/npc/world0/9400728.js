...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        cm.sendNext("So to refresh your memory a bit, here's the leaders of the  #rDark Orginazation#k.\r\nThey might look a bit like each other but that's because it is the same person.\r\nNo one know's the name of the leaders for sure but it is rumored to be #rXehanort#k and that he is using #bTime Traveling#k to mess with the #eWorld#k");
    } else if (status == 2) {
        cm.sendNextPrev("As I said before you, unfortunately lost the battle to stop him from messing with the world. I am sure with the right amount of training and focus, you'll be able to win the next battle!\r\nJust believe in yourself!");
    } else if (status == 3) {
