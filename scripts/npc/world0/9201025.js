...
function action(mode, type, selection) {
    ...
    let quest = player.getCustomQuest(POL_ORBIS);
    if (quest == null) {
        ...
        let content = "Hello, I am Nana the Love Fairy of Orbis. Living in the sky is marvelous, just look at the view! I'm sure you will visit and share wonderful memories with your significant other.\r\nPlease collect these items for me to obtain your Proof of Love. Good luck~\r\n\r\n";
