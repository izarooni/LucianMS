...
function action (mode, type, selection) {
    ...
    if (status == 1) {
        cm.sendSimple("Hiiiii cutie!\r\n\r\nMy dog found this shiny coin on our walk yesterday! I wont let you have it for free though! you can convert your mesos to #bChirithy coin#k here.\r\n\r\n#d#L0#I want to convert 1 billion meso to 1 #bChirithy coin#k");
    }
    else if (status == 2) { 
        if (selection == 0) {
