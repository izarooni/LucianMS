...
const Minigame = Java.type("com.lucianms.features.arcade.CrowOnly");
/* izarooni */
let status = 0;
...
function action(mode, type, selection) {
    ...
    if (status == 1) {
        cm.sendSimple("Are you daring enough to test your luck in this Crow Only minigame?\r\n#b"
            + `\r\n#L1#Play Crow Only (Current Highscore: ${Arcade.getHighscore(3, cm.getPlayer())})#l`
            + "\r\n#L2#How to play#l"
            + "\r\n#L3#Rankings#l");
    } else if (status == 2) {
        if (selection == 1) {
