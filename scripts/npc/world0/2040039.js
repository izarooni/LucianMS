        ...
        if (preamble == null) {
            ...
            if (complete == null) {
                if (cm.isLeader()) {
                    if(player.getMap().getCharacters().size() < eim.getPlayers().size()) {
                    ...
                    } else if(cm.haveItem(ID_Ticket, 6)){
                        cm.sendOk("Good job! you have collected all #b6 #t" + ID_Ticket + "##k's");
                        ...
                        cm.sendOk("Sorry you don't have all #b6 #t" + ID_Ticket + "#'s#k");
                    }
                } else {
