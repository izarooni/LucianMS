...
const droptable = {
  "T1": "[4005000 5],[4005001 5],[4005002 5],[4005003 5],[4005004 5],[4021000 5],[4021001 5],[4021002 5],[4021003 5],[4021004 5],[4021005 5],[4021006 5],[4021007 5],[4021008 5]",
  "T2": "[2022039 5],[2012002 5],[2012000 5],[2012001 5],[4003002 5],[4031218 5],[4001006 5],[4001005 5]",
  "T3": "[4000336 5],[4001112 5],[4001110 5],[4161021 5],[4161018 5],[4161015 5],[4161016 5],[4080011 5],[4080010 5],[4080009 5],[4080007 5]",
  "T4": "[2340000 5],[2049100 5]"
};
...
var TIER4 = 32700;
var tier = 0;
var rb_point_costs = [200, 400, 600, 1000];
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("Heya. I'm the Chirithy #drebirth point#k MSI NPC.\r\n"
      ...
      cm.sendYesNo(dialog);
        ...
        if (canCreate && checkMSI(cm.vars._item, convertToTier(tier - 1), convertToTier(tier)) && (player.getRebirthPoints() - rb_point_costs[tier - 1]) >= 0) {
            ...
            mods.clear();
            player.setRebirthPoints(player.getRebirthPoints() - rb_point_costs[tier - 1]);
            if (tier == 4) {
        ...
        else if (!checkMSI(cm.vars._item, convertToTier(tier - 1), convertToTier(tier))) {
          cm.sendOk("The item you have selected is not a tier " + (tier - 1) + " item.");
          cm.dispose();
        }
        else if (canCreate && checkMSI(cm.vars._item, convertToTier(tier - 1), convertToTier(tier)) && !(player.getRebirthPoints() - rb_point_costs[tier - 1] >= 0)) {
