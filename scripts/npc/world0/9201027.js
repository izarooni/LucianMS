...
function action(mode, type, selection) {
    ...
    let quest = player.getCustomQuest(POL_PERION);
    if (quest == null) {
        ...
        if (quest.checkRequirements()) {
            ...
            let content = "Hello, I am Nana the Love Fairy of Perion. I can tell you have a very strong relationship, nothing can come betewen you two.\r\nPlease collect these items for me to obtain your Proof of Love. Good luck~\r\n\r\n";
