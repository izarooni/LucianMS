...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void dispose() {
        NPCScriptManager.dispose(getClient());
    }
    ...
    public void createItemWithStats(int eq, short stat, short atk){
    ...
    public void createItemWithExpiration(int etc, long expiration){
        ...
        modified.setExpiration(System.currentTimeMillis() + expiration);
