...
public class Aran {
    ...
    public static final int HIDDEN_FULL_SWING_DOUBLE = 21110007;
    ...
    public static final int HIDDEN_OVER_SWING_DOUBLE = 21120009;
    public static final int HIDDEN_OVER_SWING_TRIPLE = 21120010;
