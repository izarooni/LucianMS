...
public class CreateINI {
    ...
    public static void main(String args[]) {
        ...
        for (byte b = 0; b < worlds; b++) {
            ...
            sb.append("flag").append(b).append("=").append(Integer.parseInt(con.readLine("   Flag: "))).append("\r\n");
        ...
        try (FileOutputStream out = new FileOutputStream("moople.ini", false)) {
        ...
        if (linux.equals("n")) {
            try (FileOutputStream out = new FileOutputStream("launch_server.bat", false)) {
            ...
            try (FileOutputStream out = new FileOutputStream("launch_server.sh", false)) {
